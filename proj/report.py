...
def report():
    ...
    return render_template('report.html',  tables=[report_df.to_html(classes=['w3-table','w3-bordered'], header="true", justify = 'left', sparsify = True)], report_title = f'{datatype.capitalize()} Completeness Report')
